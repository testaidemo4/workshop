WORKSHOP.register({
  ...
  mount: function (root) {
    ...
    pickButton.addEventListener("focus", function () {
      pickButton.style.outline = "3px solid #111111";
      pickButton.style.outlineOffset = "3px";
    });

    pickButton.addEventListener("blur", function () {
      pickButton.style.outline = "";
      pickButton.style.outlineOffset = "";
    });
